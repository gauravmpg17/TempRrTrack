...
import com.markss.rfidtemplate.access_operations.AccessOperationsFragment;
import com.markss.rfidtemplate.access_operations.AccessOperationsLockFragment;
import com.markss.rfidtemplate.application.Application;
import com.markss.rfidtemplate.common.Constants;
import com.markss.rfidtemplate.common.CustomProgressDialog;
import com.markss.rfidtemplate.common.CustomToast;
import com.markss.rfidtemplate.common.Inventorytimer;
import com.markss.rfidtemplate.common.MatchModeFileLoader;
import com.markss.rfidtemplate.common.ResponseHandlerInterfaces;
import com.markss.rfidtemplate.common.ResponseHandlerInterfaces.BatteryNotificationHandler;
import com.markss.rfidtemplate.common.ResponseHandlerInterfaces.ReaderDeviceFoundHandler;
...
import com.markss.rfidtemplate.data_export.DataExportTask;
...
import com.markss.rfidtemplate.locate_tag.RangeGraph;
...
import com.markss.rfidtemplate.rfid.ConnectionController;
import com.markss.rfidtemplate.rfid.RFIDController;
import com.markss.rfidtemplate.rfid.RfidListeners;
import com.markss.rfidtemplate.settings.AdvancedOptionItemFragment;
import com.markss.rfidtemplate.settings.AdvancedOptionsContent;
import com.markss.rfidtemplate.settings.BackPressedFragment;
import com.markss.rfidtemplate.settings.ISettingsUtil;
import com.markss.rfidtemplate.settings.PreFilterFragment;
import com.markss.rfidtemplate.settings.ProfileContent;
import com.markss.rfidtemplate.settings.ProfileFragment;
...
import static com.markss.rfidtemplate.application.Application.TAG_LIST_MATCH_MODE;
import static com.markss.rfidtemplate.application.Application.TOTAL_TAGS;
import static com.markss.rfidtemplate.application.Application.UNIQUE_TAGS;
...
import static com.markss.rfidtemplate.application.Application.memoryBankId;
import static com.markss.rfidtemplate.application.Application.missedTags;
import static com.markss.rfidtemplate.application.Application.missingTagsList;
import static com.markss.rfidtemplate.application.Application.strBrandID;
import static com.markss.rfidtemplate.application.Application.tagListMap;
import static com.markss.rfidtemplate.application.Application.tagsListCSV;
import static com.markss.rfidtemplate.application.Application.tagsReadForSearch;
import static com.markss.rfidtemplate.application.Application.tagsReadInventory;
import static com.markss.rfidtemplate.application.Application.unknownTagsList;
import static com.markss.rfidtemplate.rfid.RFIDController.AUTO_DETECT_READERS;
import static com.markss.rfidtemplate.rfid.RFIDController.AUTO_RECONNECT_READERS;
import static com.markss.rfidtemplate.rfid.RFIDController.BatteryData;
import static com.markss.rfidtemplate.rfid.RFIDController.EXPORT_DATA;
import static com.markss.rfidtemplate.rfid.RFIDController.LAST_CONNECTED_READER;
import static com.markss.rfidtemplate.rfid.RFIDController.NON_MATCHING;
import static com.markss.rfidtemplate.rfid.RFIDController.NOTIFY_BATTERY_STATUS;
import static com.markss.rfidtemplate.rfid.RFIDController.NOTIFY_READER_AVAILABLE;
import static com.markss.rfidtemplate.rfid.RFIDController.NOTIFY_READER_CONNECTION;
import static com.markss.rfidtemplate.rfid.RFIDController.SHOW_CSV_TAG_NAMES;
import static com.markss.rfidtemplate.rfid.RFIDController.TagProximityPercent;
import static com.markss.rfidtemplate.rfid.RFIDController.asciiMode;
import static com.markss.rfidtemplate.rfid.RFIDController.bFound;
import static com.markss.rfidtemplate.rfid.RFIDController.beeperVolume;
import static com.markss.rfidtemplate.rfid.RFIDController.brandidcheckenabled;
import static com.markss.rfidtemplate.rfid.RFIDController.channelIndex;
import static com.markss.rfidtemplate.rfid.RFIDController.clearInventoryData;
import static com.markss.rfidtemplate.rfid.RFIDController.currentFragment;
import static com.markss.rfidtemplate.rfid.RFIDController.dynamicPowerSettings;
import static com.markss.rfidtemplate.rfid.RFIDController.getInstance;
import static com.markss.rfidtemplate.rfid.RFIDController.inventoryMode;
import static com.markss.rfidtemplate.rfid.RFIDController.isAccessCriteriaRead;
import static com.markss.rfidtemplate.rfid.RFIDController.isBatchModeInventoryRunning;
import static com.markss.rfidtemplate.rfid.RFIDController.isGettingTags;
import static com.markss.rfidtemplate.rfid.RFIDController.isInventoryAborted;
import static com.markss.rfidtemplate.rfid.RFIDController.isLocatingTag;
import static com.markss.rfidtemplate.rfid.RFIDController.isLocationingAborted;
import static com.markss.rfidtemplate.rfid.RFIDController.isTriggerRepeat;
import static com.markss.rfidtemplate.rfid.RFIDController.is_connection_requested;
import static com.markss.rfidtemplate.rfid.RFIDController.is_disconnection_requested;
import static com.markss.rfidtemplate.rfid.RFIDController.ledState;
import static com.markss.rfidtemplate.rfid.RFIDController.mConnectedDevice;
import static com.markss.rfidtemplate.rfid.RFIDController.mConnectedReader;
import static com.markss.rfidtemplate.rfid.RFIDController.mInventoryStartPending;
import static com.markss.rfidtemplate.rfid.RFIDController.mIsInventoryRunning;
import static com.markss.rfidtemplate.rfid.RFIDController.mRRStartedTime;
import static com.markss.rfidtemplate.rfid.RFIDController.mReaderDisappeared;
import static com.markss.rfidtemplate.rfid.RFIDController.pc;
import static com.markss.rfidtemplate.rfid.RFIDController.phase;
import static com.markss.rfidtemplate.rfid.RFIDController.readers;
import static com.markss.rfidtemplate.rfid.RFIDController.regionNotSet;
import static com.markss.rfidtemplate.rfid.RFIDController.reset;
import static com.markss.rfidtemplate.rfid.RFIDController.rssi;
import static com.markss.rfidtemplate.rfid.RFIDController.settings_startTrigger;
import static com.markss.rfidtemplate.rfid.RFIDController.settings_stopTrigger;
import static com.markss.rfidtemplate.rfid.RFIDController.tagListMatchAutoStop;
...
public class MainActivity extends BaseActivity implements Readers.RFIDReaderEventHandler,
    ...
    public static com.markss.rfidtemplate.home.MainActivity.EventHandler eventHandler;
    ...
    private void loadReaders(final com.markss.rfidtemplate.home.MainActivity context) {
        new AsyncTask<Void, Void, Boolean>() {
            @Override
            protected Boolean doInBackground(Void... voids) {
                InvalidUsageException invalidUsageException = null;
                ArrayList<ReaderDevice> readersListArray = readers.GetAvailableRFIDReaderList();
                Log.d("checkReaders", "" + readersListArray);
//                try {
//                    ArrayList<ReaderDevice> readersListArray = readers.GetAvailableRFIDReaderList();
//                } catch (InvalidUsageException e) {
//                    e.printStackTrace();
...
//                }
    ...
    public synchronized void AutoConnectDevice() {
        ...
        if (com.markss.rfidtemplate.home.MainActivity.isActivityVisible()) {
            progressDialog =
                    new CustomProgressDialog(com.markss.rfidtemplate.home.MainActivity.this,
    ...
    private void disconnectReaderConnections() {
        ...
        if (readers != null) {
            readers.deattach(com.markss.rfidtemplate.home.MainActivity.this);
            readers.Dispose();
            readers = null;
        }
        reset();
...
//                break;
    ...
    public void selectItem(int position) {
        ...
        switch (position) {
            ...
            case 9:
                ...
                break;
            case 10:
                fragment = new TagReaderFragment();
                break;
        }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            } else if (fragment != null && fragment instanceof asset.trak.views.fragments.HomeFragment) {
                //stop Timer
                        ...
                        if (Application.multiTagLocateTagListMap.containsKey(tagID)) {
                            try {
                                if (mConnectedReader.Actions.MultiTagLocate.deleteItem(tagID) == 0) {
                                    ...
                                    FancyToast.makeText(
                                            getApplicationContext(),
                                            getResources().getString(R.string.multiTag_locate_delete_item_success),
                                            FancyToast.LENGTH_LONG,
                                            FancyToast.SUCCESS,
                                            false
                                    ).show();
     ...
     */
    /**
     * RR button in {@link com.markss.rfidtemplate.rapidread.RapidReadFragment} is clicked
     *
    ...
    /**
     * Inventory button in {@link com.markss.rfidtemplate.inventory.InventoryFragment} is clicked
     *
     * @param view - Button clicked
     */
    ...
    /**
     * Locationing button in {@link com.markss.rfidtemplate.locate_tag.SingleTagLocateFragment} is clicked
     *
     * @param view - Button clicked
     */
    ...
    /**
     * Settings button in {@link com.markss.rfidtemplate.settings.SettingListFragment} is clicked
     *
     * @param view - Button clicked
     */
    ...
    /**
     * Access button in {@link com.markss.rfidtemplate.access_operations.AccessOperationsFragment} is clicked
     *
     * @param view - Button clicked
     */
    ...
    /**
     * Filter button in {@link com.markss.rfidtemplate.settings.PreFilterFragment} is clicked
     *
     * @param view - Button clicked
     */
    ...
    /**
     * About option in {@link com.markss.rfidtemplate.home.AboutFragment} is selected
     */
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (batteryData.getCause().trim().equalsIgnoreCase(Constants.MESSAGE_BATTERY_CRITICAL))
                            sendNotification(com.markss.rfidtemplate.common.Constants.ACTION_READER_BATTERY_CRITICAL, getString(R.string.battery_status__critical_message));
                        else if (batteryData.getCause().trim().equalsIgnoreCase(Constants.MESSAGE_BATTERY_LOW))
                            sendNotification(com.markss.rfidtemplate.common.Constants.ACTION_READER_BATTERY_CRITICAL, getString(R.string.battery_status_low_message));
                    }
                });
            }
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (matchingTags != 0 && missedTags == 0 && !tagListMatchNotice) {
                        ...
                        FancyToast.makeText(
                                getApplicationContext(),
                                getResources().getString(R.string.tag_match_complete),
                                FancyToast.LENGTH_LONG,
                                FancyToast.WARNING,
                                false
                        ).show();
...
//                ((ResponseHandlerInterfaces.ResponseTagHandler) fragment).handleTagResponse(oldObject, result);
    ...
    public void callBackPressed() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                com.markss.rfidtemplate.home.MainActivity.super.onBackPressed();
            }
        });
    }
