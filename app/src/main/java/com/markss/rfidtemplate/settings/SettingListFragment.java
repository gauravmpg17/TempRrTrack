...
public class SettingListFragment extends ListFragment {
    ...
    public static com.markss.rfidtemplate.settings.SettingListFragment newInstance() {
        com.markss.rfidtemplate.settings.SettingListFragment fragment = new com.markss.rfidtemplate.settings.SettingListFragment();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ((MainActivity) getActivity()).backLay.setVisibility(View.VISIBLE);
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        detailsIntent.putExtra(Constants.SETTING_ITEM_ID,
                Integer.parseInt(SettingsContent.ITEMS.get(position).id));
