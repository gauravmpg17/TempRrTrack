...
import com.markss.rfidtemplate.common.LinkProfileUtil;
...
import static com.markss.rfidtemplate.rfid.RFIDController.TAG;
import static com.markss.rfidtemplate.rfid.RFIDController.antennaRfConfig;
...
import static com.markss.rfidtemplate.rfid.RFIDController.singulationControl;
...
public class ProfileContent {
    ...
    public static void UpdateProfilesForRegulatory() {
        ...
        com.markss.rfidtemplate.settings.ProfileContent.ProfilesItem FastReadProfile = com.markss.rfidtemplate.settings.ProfileContent.ITEMS.get(0);
        com.markss.rfidtemplate.settings.ProfileContent.ProfilesItem DenseModeProfile = com.markss.rfidtemplate.settings.ProfileContent.ITEMS.get(2);
        com.markss.rfidtemplate.settings.ProfileContent.ProfilesItem CycleCountProfile = com.markss.rfidtemplate.settings.ProfileContent.ITEMS.get(1);
        com.markss.rfidtemplate.settings.ProfileContent.ProfilesItem OptBatteryProfile = com.markss.rfidtemplate.settings.ProfileContent.ITEMS.get(3);
        com.markss.rfidtemplate.settings.ProfileContent.ProfilesItem BalancePerformProfile = com.markss.rfidtemplate.settings.ProfileContent.ITEMS.get(4);
        com.markss.rfidtemplate.settings.ProfileContent.ProfilesItem UserProfile = com.markss.rfidtemplate.settings.ProfileContent.ITEMS.get(5);
    ...
    public static void UpdateActiveProfile() {
        com.markss.rfidtemplate.settings.ProfileContent.ProfilesItem item;
        ...
        if (!ActiveProfile.content.equals("Reader Defined"))
            item = com.markss.rfidtemplate.settings.ProfileContent.ITEMS.get(5);
        else
            item = com.markss.rfidtemplate.settings.ProfileContent.ITEMS.get(6);
