...
public class MatchModeFileLoader {
    ...
    private static com.markss.rfidtemplate.common.MatchModeFileLoader m_instance;
    ...
    public static com.markss.rfidtemplate.common.MatchModeFileLoader getInstance(Context context) {
        if (m_instance == null)
            m_instance = new com.markss.rfidtemplate.common.MatchModeFileLoader(context);
