package com.markss.rfidtemplate.common;
...
public class LinkProfileUtil {
    ...
    private static com.markss.rfidtemplate.common.LinkProfileUtil instance;
    ...
    public static com.markss.rfidtemplate.common.LinkProfileUtil getInstance() {
        if (instance == null)
            instance = new com.markss.rfidtemplate.common.LinkProfileUtil();
        return instance;
    }

    public int getSelectedLinkProfilePosition(long rfModeTableIndex) {
        for (com.markss.rfidtemplate.common.LinkProfileItem item : LinkProfileList)
    ...
    public void populateLinkeProfiles() {
        ...
        if (mConnectedReader != null && mConnectedReader.isConnected() && rfModeTable != null) {
            ...
            for (int i = 0; i < rfModeTable.length(); i++) {
                ...
                LinkProfileList.add(new com.markss.rfidtemplate.common.LinkProfileItem(simpleProfiles.indexOf(profile), profile, rfModeTableEntry));
