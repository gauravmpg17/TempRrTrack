...
public class Inventorytimer {
    ...
    private static com.markss.rfidtemplate.common.Inventorytimer inventorytimer;
    private static long startedTime;
    private Activity activity;
    private ScheduledExecutorService scheduler;
    private ScheduledFuture<?> rrTimer;

    public static com.markss.rfidtemplate.common.Inventorytimer getInstance() {
        if (inventorytimer == null)
            inventorytimer = new com.markss.rfidtemplate.common.Inventorytimer();
