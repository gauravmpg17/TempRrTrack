...
public class RFIDController {
    ...
    private static volatile com.markss.rfidtemplate.rfid.RFIDController instance;
    ...
    public static com.markss.rfidtemplate.rfid.RFIDController getInstance() {
        com.markss.rfidtemplate.rfid.RFIDController result = instance;
        if (result == null) {
            synchronized (mutex) {
                result = instance;
                if (result == null)
                    instance = result = new com.markss.rfidtemplate.rfid.RFIDController();
            }
        }
        return result;
    }
    ...
    public static boolean isSimplePreFilterEnabled() {
        ...
        if (preFilters[0].getMemoryBank().contains("EPC") && com.markss.rfidtemplate.rfid.RFIDController.preFilters[0].getAction() == 4 && com.markss.rfidtemplate.rfid.RFIDController.preFilters[1] == null)
            return true;
